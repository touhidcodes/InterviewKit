            ...
            <div className="container flex h-14 items-center justify-between">
              <div className="flex items-center gap-8">
                <Link className="flex items-center space-x-2" href="/">
                  <span className="font-bold text-xl tracking-tight">InterviewKit</span>
                </Link>
                <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
                  <Link href="/docs/javascript" className="transition-colors hover:text-foreground">Docs</Link>
                  <Link href="/docs/system-design" className="transition-colors hover:text-foreground">System Design</Link>
                  <Link href="/docs/problem-solving" className="transition-colors hover:text-foreground">Algorithms</Link>
                </nav>
              </div>
